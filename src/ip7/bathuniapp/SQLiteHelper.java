...
/*
 *  Create a database, if one does not exist already, 
 *  with tables and attributes equivalent to tasks
 *  and events
 */
public class SQLiteHelper extends SQLiteOpenHelper {
    ...
    private static final String TASK_DATABASE_CREATE = "create table "
            ...
            + " text not null, " + COLUMN_PRIORITY + " int, "
            + COLUMN_DESCRIPTION + " text, " + COLUMN_PARENT_ID + " int, "
            + COLUMN_COMPLETE + " int, " + COLUMN_DATE + " int);";
    ...
    private static final String EVENT_DATABASE_CREATE = "create table "
            ...
            + COLUMN_LOCATION + " text, " + COLUMN_COURSE + " text, "
